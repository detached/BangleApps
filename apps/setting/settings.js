...
function showMainMenu() {
  ...
  const mainmenu = {
    ...
    'Auto-On Sensitivity': showAutoOnSensitivityMenu,
...
function showAutoOnSensitivityMenu() {
  const sensitivityMenu = {
    '': { 'title': 'Auto-On Sensitivity' },
    '< Back': showMainMenu,
    'Wake On Twist': {
  ...
  return E.showMenu(sensitivityMenu)
}
